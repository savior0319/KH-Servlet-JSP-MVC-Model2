...
public class FileDown2Servlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public FileDown2Servlet2() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (mv != null) {
			...
			FileVo2 fv = new FileService().fileDownLoad2(fileName, uploadTime);
			...
			if (fv != null) {
				...
				String encFileName = new String(fv.getBeforeFileName().getBytes(), "ISO-8859-1");
