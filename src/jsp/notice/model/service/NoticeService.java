...
public class NoticeService {
	...
	public PageDataVo noticeSearchTitle(int currentPage, String title) {
		...
		// 2. 현재 중심으로 만들어지는 navi 리스트
		String pageNavi = nDao.noticeSearchTitle(conn, currentPage, recordCountPerPage, naviCountPerPage, title);
